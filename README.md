...
[![A run in progress: live progress, the streamed answer and the metrics](docs/screenshots/test-run.png)](https://raw.githubusercontent.com/AnonBOTpl/LLM-Benchmark/main/docs/screenshots/test-run.png)

<a href="https://raw.githubusercontent.com/AnonBOTpl/LLM-Benchmark/main/docs/screenshots/classification.png"><img src="docs/screenshots/classification.png" width="200" alt="Manual response classification"></a> <a href="https://raw.githubusercontent.com/AnonBOTpl/LLM-Benchmark/main/docs/screenshots/results.png"><img src="docs/screenshots/results.png" width="200" alt="Results table with an A/B comparison"></a> <a href="https://raw.githubusercontent.com/AnonBOTpl/LLM-Benchmark/main/docs/screenshots/models.png"><img src="docs/screenshots/models.png" width="200" alt="Model panel with live VRAM state"></a> <a href="https://raw.githubusercontent.com/AnonBOTpl/LLM-Benchmark/main/docs/screenshots/model-search.png"><img src="docs/screenshots/model-search.png" width="200" alt="HuggingFace catalogue with memory verdicts"></a>
